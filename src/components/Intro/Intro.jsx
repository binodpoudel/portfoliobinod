    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          {/* change  darkmode  */}
          <span style={{ color: darkMode ? "white" : "",  fontSize:'18px'}}>Hi There! My name is</span>
          <span style={{ fontSize:'22px'}}>Binod Poudel</span>
          ...
          <span className="about">
           I am from the Himalayan country of Nepal. 
            ...
            <br />
            And I love to have fun coding!<br /> 
           Let's make something cool together!<br />
           Focusing on Front-end (React) developer.
          </span>
          <span className="hire">
           {/* Do you like my work? */}
            <br />
